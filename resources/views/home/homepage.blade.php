...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="col-lg-12" style="font-family: 'Work Sans', sans-serif;">
            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <a href="#" class="btn btn-success btn-sm ms-4">{{$d->fees }}</a>
                                ...
                                @endauth
                                @guest
                                 <a href="{{ route('register') }}" class="btn btn-danger w-100 btn-sm mt-3 float-auto">Register First</a>
                                @endguest
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                               <a href="" class="btn btn-secondary btn-sm btn-outline-success text-white w-100" style="background-color: rgb(36, 177, 133)"><h4>{{ $d->name }}</h4></a>
                                <h5 class="">{{ $d->qualification }}</h5>
                                <h5 class="">Speciality : {{ $d->speciality }}</h5>
                                <h5 class="">{{ $d->category }}</h5>
                                <h5 class="">Experience : {{ $d->experience }}</h5>
                                <h5 class="">Time : {{ $d->visiting_hour }}</h5>
                                <p class="lead">{{ $d->address }} , {{ $d->country }}</p>
                                <h6 class="">Contact:-{{ $d->contact }}, Email:-{{ $d->email }}</h6>
...
<div class="container-fluid bg-dark mt-2">
    <div class="row text-white">
        ...
        <div class="col-lg-6">
            <h5 class="text-center text-white mt-3">Contact US</h5>
            <h6 class="text-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
    ...
    <div class="row bg-secondary mt-2" height="50px">
        <div class="col">
            <h6 class="lead">Copyright © 2021 All India Institute of Medical Sciences, Delhi </h6>
        </div>
        <div class="col">
            <h6 class="lead text-end"> Powered By AIIMS Delhi</h6>
        </div>
